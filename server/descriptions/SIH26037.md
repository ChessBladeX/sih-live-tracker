...
- **Live Submissions:** 24 / 500 (4.8%)
- **Slots Remaining:** 476
- **Status:** LOW (<20%)
- **Deadline:** 30 September 2026
- **YouTube Video:**  
- **Dataset Link:** Teams may use built-in sensor and scenario datasets available in MathWorks Automated Driving Toolbox, RoadRunner sample scenes, synthetic scenarios created by the team, and publicly available traffic datasets relevant to Indian
road conditions.
